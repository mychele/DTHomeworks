...
\end{equation}
followed by the polyphase compoment of a prototype filter, which in our case is a $\delta_n$ filter, with a gain $\mathcal{M}$ as specified in \cite{bc}, then we have 
