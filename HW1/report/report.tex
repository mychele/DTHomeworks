...
% plot from first_spectral_analysis
\begin{figure}[h!]
  \centering
...
% plot from first_spectral_analysis, section about periodogram accumulation
\begin{figure}[h!]
  \centering
...
\begin{figure}[h!]
  %use subfigures, or update the comments above
